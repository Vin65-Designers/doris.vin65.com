...
<body>
	...
	<section class="content homepageContent v65-group" aria-label="Main Content">
	...
	<cf_js files="/assets/js/scripts.js,/assets/js/track-focus.min.js,/assets/nivo/jquery.nivo.slider.pack.js,/assets/js/invertcolours.js">
